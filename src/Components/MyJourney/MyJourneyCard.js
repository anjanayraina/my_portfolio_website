...
<p>After all that, I kept dabbling in some more tech stacks. I did some work in <strong className="purple">Machine Learning, Backend Dev in Java, and Front End Web Dev</strong> . But in the end, I learned about the world of <strong className="purple">Web3</strong> . I really liked being a <strong className="purple">Blockchain Developer</strong>  and have stuck to it till now , recently i have also started to work in the security side of Blockchain as well. Apart from dev, I also started learning <strong className="purple">DSA</strong> , and i regularly solve problems on Leetcode even to this day.</p>
